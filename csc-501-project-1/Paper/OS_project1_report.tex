...
\subsection{Goals}
Our primary goal was to benchmark the CPU and memory in details and analyze the results to draw conclusions about their performance. The CPU experiments are designed and implemented by Anubhab Majumdar. Arun Jaganathan designed the experiments to test memory components and implementation was shared by both the authors. 
